        ...
        if (c == '\n') {  // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (outputState == "on") {
              ...
              client.println("<!DOCTYPE html><html lang=\"en\"><head> <meta charset=\"UTF-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"> <title>Code correct</title></head><body> <h1>Code bon !</h1> <a href=\"/home\"><button>retour</button></a></body></html>");
            } 
            if (outputState == "off"){
              digitalWrite(outputPin, LOW);
